...
# json_path = os.path.join(get_package_share_directory('realsense2_camera'), 'json', 'HighResMedDensityPreset.json')
json_path = os.path.join(get_package_share_directory('realsense2_camera'), 'json', 'aaaa.json')
...
local_parameters = [{'name': 'enable_pointcloud',    'default': 'true',     'description': 'enable pointcloud'},
                    ...
                    {'name': 'infra_width',          'default': '1280',       'description': 'infra width'},
                    {'name': 'infra_height',         'default': '720',       'description': 'infra width'},
                    {'name': 'align_depth',          'default': 'false',     'description': ''},
                    {'name': 'depth_fps',            'default': '60.',      'description': ''},
                    {'name': 'color_fps',            'default': '60.',      'description': ''},
                    ...
                    {'name': 'json_file_path',       'default': f"'{json_path}'",       'description': 'allows advanced configuration'},
                   ]
