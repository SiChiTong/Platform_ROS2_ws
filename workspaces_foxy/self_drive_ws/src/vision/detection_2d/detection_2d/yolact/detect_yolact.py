...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default=SHARE_DIR + '/weights/yolact_resnet50_54_800000.pth', type=str,
...
def evaluate(net: Yolact, video=None, images=None, image=None):
...
class detection_node(Node):
    def __init__(self, model):
        ...
        self.pub_check = self.create_publisher(String,'/check',1)
    ...
    def callback_rgbd(self, msg: RGBDImage):
        ...
        with torch.no_grad():
            ...
            result, img_result = evalimage_np(self.model, img)
...
def evalimage_np(net: Yolact, img: np.ndarray):
    net.detect.use_fast_nms = args.fast_nms
    net.detect.use_cross_class_nms = args.cross_class_nms
    cfg.mask_proto_debug = args.mask_proto_debug
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        print('Initialize ROS2 Node...', end='')
        rclpy.init(args=None)
        node = detection_node(net)
        print(' Done.')
