...
def generate_node_set(cells, width, step=None, safeWidth=None, threshold_last_step=None):
    nodes = []
    ...
    for curr_node in nodes:
        ...
        curr_node.inside_path = sweep(curr_node.polygon, width, step, safeWidth, threshold_last_step)
    return nodes
